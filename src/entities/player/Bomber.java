...
import static core.Game.gameState;
...
public class Bomber extends Player {
    ...
    public int STEP = 2; // Reduced step size for smoother movement
    ...
    private void chooseSprite() {
        animate += STEP/2; // Sync animation speed with movement steps
        ...
        switch (direction) {
            case U:
                ...
                if (moving) {
                    sprite = Sprite.movingSprite(Sprite.player_up_1, Sprite.player_up_2, animate, 40/STEP); // Adjust animation interval
                }
                break;
            case D:
    ...
    protected void AIDirection() {
        if (true) { // Remove grid alignment check for smoother movement
            animate += STEP/2; // Sync animation speed with movement steps
            if (animate > 100000) animate = 0;
